...
const messages = {
  "zh-CN": {
    nav: { workspace: "工作区", system: "系统", home: "概览", accounts: "SV2 账号", lyrics: "作词", history: "历史", copilot: "Copilot", components: "组件中心", bridge: "SynthV Bridge", connections: "连接", settings: "设置", expand: "展开侧栏", collapse: "收起侧栏" },
  ...
  en: {
    nav: { workspace: "WORKSPACE", system: "SYSTEM", home: "Overview", accounts: "SV2 Accounts", lyrics: "Lyrics", history: "History", copilot: "Copilot", components: "Components", bridge: "SynthV Bridge", connections: "Connections", settings: "Settings", expand: "Expand sidebar", collapse: "Collapse sidebar" },
