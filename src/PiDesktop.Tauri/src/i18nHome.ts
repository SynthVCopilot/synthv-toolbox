...
addMessages("zh-CN", { home: {
  ...
  openCopilot: "打开 Copilot", openImport: "打开导入", checkBridge: "检查 Bridge", mode: "运行模式", ai: "AI 增强", toolbox: "纯工具箱", runtimeOff: "模型运行时已停用",
...
addMessages("en", { home: {
  ...
  openCopilot: "Open Copilot", openImport: "Open Import", checkBridge: "Check Bridge", mode: "Runtime mode", ai: "AI enhanced", toolbox: "Toolbox only", runtimeOff: "Model runtime disabled",
