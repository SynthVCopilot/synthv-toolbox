...
assert.match(source, /FLAT_MAC_SCRIPTS/);
assert.match(source, /Anthronics\/Synthesizer V Studio\/scripts/);
assert.match(source, /Documents\/Dreamtonics\/Synthesizer V Studio\/scripts/);
assert.match(source, /windows_flat_script_candidates/);
assert.match(source, /windows_flat_status_candidates/);
