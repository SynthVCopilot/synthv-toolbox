...
assert.equal(instanceProjectTitle("Synthesizer V Studio 2 Pro 2.3.0"), "未命名工程");
assert.equal(instanceProjectTitle("* Unsaved.svp - Synthesizer V Studio 2 Pro"), "* Unsaved.svp");
