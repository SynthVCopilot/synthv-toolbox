...
assert.match(commands, /pub async fn configure_http_api\([\s\S]*internal_enabled: bool,[\s\S]*advanced_enabled: bool/);
assert.match(commands, /settings\.http_mcp_internal_enabled = internal_enabled/);
assert.match(commands, /settings\.http_mcp_advanced_enabled = advanced_enabled/);
assert.match(commands, /context\.mcp_internal_enabled = internal_enabled/);
assert.match(commands, /context\.mcp_advanced_enabled = advanced_enabled/);
...
assert.match(rust, /if context\.mcp_internal_enabled[\s\S]*toolbox_internal/);
assert.match(rust, /if context\.mcp_advanced_enabled[\s\S]*toolbox_advanced/);
