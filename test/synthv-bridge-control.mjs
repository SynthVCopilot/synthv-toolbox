...
assert.match(agent, /list_synthv_processes/);
assert.match(agent, /read_synthv_bridge_shortcuts/);
assert.match(agent, /send_synthv_bridge_shortcut/);
assert.match(agent, /auto_connect_synthv_bridge/);
