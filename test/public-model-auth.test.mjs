...
for (const name of ["core", "providers"]) {
  assert.equal(
    ...
    `${release}/model-auth-${name}-0.5.1.tgz`,
  );
}
assert.equal(manifest.dependencies["@model-auth/vue"], "https://github.com/lsy-404/platform-kit/releases/download/v0.5.1/model-auth-vue-0.5.1.tgz");
