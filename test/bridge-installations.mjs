...
const synthv = read('../src/PiDesktop.Tauri/electron/services/synthv-service.ts');
const commands = read('../src/PiDesktop.Tauri/electron/services/synthv-commands.ts');
...
assert.match(commands, /install_bridge/);
assert.match(commands, /diagnose_bridge/);
